...
import common.py.module_get_local_ip as _ip
import common.py.module_read_file as _file
...
def f_get_data():
    try:
        ...
        _data_path="py_flask_server/db/"+_month+".csv"
...
def f_get_months():
    try:
        _dirs=os.listdir("py_flask_server/db/")
